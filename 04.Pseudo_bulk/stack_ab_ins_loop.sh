...
batchfile=($(cat /research/xieyeming1/proj_2023/zhichao_snHiChew400cellgm12878_20240930/hic_pro_metrics_sum/240923_M004_V350286856_L01_CWHPE24090158-N1/hic_pro_metrics.xls|awk '$2>5000'|grep -v sample|awk '{print $1}'))
sample_id=(${batchfile[@]##*/})
echo ${sample_id[@]}|wc
