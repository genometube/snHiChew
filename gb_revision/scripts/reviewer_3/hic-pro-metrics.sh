...
proj_dir=/research/xieyeming1/proj_2023/hichew_paper_20230710/scHiC_benchmark/bulkHiChew_5k_500_50
echo ==========START at `date`==========
...
sample="$1"
hic_results="${proj_dir}/hic_pro/${sample}/outdir/hic_results"
