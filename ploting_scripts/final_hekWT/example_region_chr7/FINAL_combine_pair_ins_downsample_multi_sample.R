...
plot_list <- list()
#chr7  145813453  148118090  NM_014141.5     6.49    26047      2304637
#chr7	121958478	122526813 NM_001009571.3 11.44	93664
# chr7	110303106	111202573	rna_seq	17.56	83943
...
for(i in 1:length(sample_group)){
  ...
  p<-grid.grabExpr(draw(Heatmap(dat_mtx__ins, name = "ins", cluster_rows = dend, 
                                cluster_columns = FALSE,col=colorRampPalette(c("darkgreen",'white','darkred'))(50),
                                show_row_names = FALSE,show_column_names = FALSE,
