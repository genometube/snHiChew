...
pairs_thres_lower<-35000
pairs_thres_high<-80001
################## knee cut off ##################
batch_f<- list(testis_zhichao_dipC="empty_filtered_zhichao_dipC_testis_20240115",
...
pdf(paste0('scHiC_hic_pro_compare_testis.pdf'),height=10,width=15)
