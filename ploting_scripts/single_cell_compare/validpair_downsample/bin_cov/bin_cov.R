...
dip_C_bin_cov<-read.table('LiMCA_bin_cov.xls',header=FALSE)
colnames(dip_C_bin_cov)<-c('cell','bin','non_zero_cov_pct')
dip_C_bin_cov$sample<-'LiMCA_gm12878'
...
stack_df$sample<-factor(stack_df$sample,levels=c('sciHiC_gm12878','LiMCA_gm12878','snHiChew_gm12878'))
