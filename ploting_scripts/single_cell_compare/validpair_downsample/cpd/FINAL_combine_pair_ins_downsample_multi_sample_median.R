...
#end-start
sample_group<-c('62500','125000','250000','500000','all')
sample='hichew_293t'
bin=25000
clust_num=2
clust_method="ward.D"
...
pdf(paste0('validpair_downsample_sc_ins_cell_',start,'_',end,'_',clust_method,'.pdf'),height = 18,width = 30)
...
png(paste0('validpair_downsample_sc_ins_cell_',start,'_',end,'_',clust_method,'.png'),height = 1800,width = 3000)
cowplot::plot_grid(plotlist = plot_list, nrow = 1)
dev.off()
