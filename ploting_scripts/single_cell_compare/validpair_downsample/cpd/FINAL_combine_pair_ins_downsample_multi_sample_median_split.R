...
pdf(paste0('validpair_downsample_sc_ins_cell_',start,'_',end,'.pdf'),height = 18,width = 6)
...
png(paste0('validpair_downsample_sc_ins_cell_',start,'_',end,'.png'),height = 1800,width = 600)
cowplot::plot_grid(plotlist = plot_list, nrow = 1)
dev.off()
